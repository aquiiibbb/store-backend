const Reservation = require('../model/un5');
const { sendReservationEmail, sendAdminNotification } = require('../Config/nodemailers');

const createReservation6 = async (req, res) => {
  try {
    console.log('Received un5 reservation request:', req.body);
    ...
    console.log('Un5 reservation saved:', reservation._id);
