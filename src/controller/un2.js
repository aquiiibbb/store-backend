const Reservation = require('../model/un2');
const { sendReservationEmail, sendAdminNotification } = require('../Config/nodemailers');

const createReservation3 = async (req, res) => {
  try {
    console.log('Received un2 reservation request:', req.body);
    ...
    console.log('Un2 reservation saved:', reservation._id);
