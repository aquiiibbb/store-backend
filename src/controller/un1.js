const Reservation = require('../model/un1');
const { sendReservationEmail, sendAdminNotification } = require('../Config/nodemailers');

const createReservation2 = async (req, res) => {
  try {
    console.log('Received un1 reservation request:', req.body);
    ...
    console.log('Creating un1 reservation...');
    ...
    console.log('Un1 reservation saved successfully:', reservation._id);
    ...
    console.error('Un1 reservation error details:', {
